...
void MUX::setNewChannel(const uint8_t tcaPos) { tcaPos_ = tcaPos; }
...
void MUX::setMatchingI2C(const uint8_t address) { findI2C(false, address); }

uint8_t MUX::getTcaPos() { return tcaPos_; }
