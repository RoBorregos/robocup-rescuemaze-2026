...
void Motor::initialize(uint8_t in_1, uint8_t in_2, uint8_t en,
                       uint8_t numMotor) {
  in1 = in_1;
  in2 = in_2;
  enable = en;
...
double Motor::getSpeed() { return speed; }
int Motor::getTicsSpeed() { return ticsSpeed; }
